...
def pic_diff(folder, folder_base, report_folder):
    ...
    for file_name in os.listdir(folder):
        if(not file_name.endswith(".png")):
            continue
        image_1_path = os.path.join(folder_base, file_name)
        if(not os.path.exists(image_1_path)):
            continue
        image_2_path = os.path.join(folder, file_name)
        ...
        cv2.imwrite(os.path.join(report_folder, file_name),image_2)
...
if __name__ == '__main__':
    ...
    html(r"../", r"../../base/", r"D:\quicktest\20180903_1618_6.0.1\report")
