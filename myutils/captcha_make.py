...
#! @Auther : Yu Kunjiang
#! @File : captcha_make.py

import string
import random
from PIL import Image, ImageDraw, ImageFont

# 参考：https://mp.weixin.qq.com/s/fk0lqyNyRfKCuuLjdmkhsA
# 制作验证码
...
class Captcha():
    ...
    def draw_text(self, draw, text, font, captcha_width, captcha_height, spacing=20):
        ...
        # 得到每个字体的大概宽度
        every_value_width = text_width // 4
        ...
        # 获取第一个字符绘制位置
        start_width = (captcha_width - total_spacing - text_width) // 2
        start_height = (captcha_height - text_height) // 2
    ...
    def make_captcha(self):
        ...
        # 获取字体对象
        font = ImageFont.truetype('C:\Windows\Fonts\simkai.ttf',self.font_size)
        # 获取画笔对象
